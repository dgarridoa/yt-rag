...
def spark() -> Generator[SparkSession, None, None]:
    ...
    _builder = (
        SparkSession.builder.master("local[1]")  # type: ingore
        .config("spark.databricks.sql.initial.catalog.name", "spark_catalog")
        .config(
...
def mlflow_local():
    ...
    * Active run will be automatically stopped to avoid verbose errors.
    ...
    os.environ["MLFLOW_EXPERIMENT_NAME"] = "/Shared/yt_rag/dev_yt_rag"
    yield None
